          ...
          Flexible(
            child: Row(
              children: <Widget>[
                ...
                _buildStatCard('Mortes', "${currencyFormat.format(mortes)}", kDeathColor),
              ],
            ),
          ),
          Flexible(
            child: Row(
              children: <Widget>[
                _buildStatCard('Recuperados', "${currencyFormat.format(recuperados)}" == '0' ? "N/A" : recuperados.toString(), kColorRecover),
                _buildStatCard('Suspeitas', "${currencyFormat.format(suspeitos)}" == '0' ? "N/A" : suspeitos.toString(), kSuspectsColor),
              ],
            ),
          ),
        ],
